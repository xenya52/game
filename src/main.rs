...
mod world;
use world::{bboard_print, init_board, init_cave, init_overworld, Board, World};
mod game_logic;
use game_logic::{BasicNeeds, Materials, Entity, game_over, 
    print_overworld, print_cave,
    show_entity_status, entity_moved};
fn main() {
    let better___bbboard: Board = init_board(34, 17);
    ...
    // let starter_needs: B2asicNeeds = BasicNeeds::new(10, 10, 10);
